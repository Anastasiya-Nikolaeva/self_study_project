...
Тестирование можно запустить командой: python manage.py test

### Процент покрытия тестами

Текущий процент покрытия кода тестами составляет более **80%**. Это означает, что 80% строк кода были выполнены во время 
